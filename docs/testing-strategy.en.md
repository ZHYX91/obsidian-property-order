...
- schema 3-to-4 settings migration, valid `recent`, immediate application, persistence failure, Retry, all three sorts and the clear action in both pre-1.13 tabs and 1.13 declarative pages, custom control storage, and narrow-layout CSS;
