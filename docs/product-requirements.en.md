...
- Support native, name, recently used, and Markdown-note-count ordering plus per-property no-candidate (`none`) behavior, per-property sort overrides, and separate pinned, bottom, and hidden rules.
